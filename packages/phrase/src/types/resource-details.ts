export type ResourceDetailsTranslation = {
    ...
    security_tab: string,
    disable_resource: string,
    activate_resource: string,
    resource_disabled: string,
    resource_activated: string,
    activate_action: string,
    disable_action: string,
    activate_resource_reminder: string,
    disable_resource_reminder: string,
    security: {
        security: string,
